...
void main() {
  group('ObservableListUndefinedFailure', () {
    group('length', () {
      test('should return the length of the list', () {
        final RxListUndefinedFailure<int, String> list = RxListUndefinedFailure<int, String>(initial: <int>[1, 2, 3]);
        ...
        expect(list.length, StateOf<int, UndefinedFailure<String>>.custom(UndefinedFailure<String>.failure('failure')));

        list.setUndefined();
        expect(list.length, StateOf<int, UndefinedFailure<String>>.custom(UndefinedFailure<String>.undefined()));
      });
    });
    ...
    group('changeFactory', () {
      test('should change the factory of the list', () async {
        final RxListUndefinedFailure<int, String> rxList = RxListUndefinedFailure<int, String>(initial: <int>[1, 2, 3]);
        final ObservableListUndefinedFailure<int, String> rxNew = rxList.changeFactory((final Iterable<int>? items) {
    ...
    group('filterItem', () {
      test('should filter the items of the list', () async {
        final RxListUndefinedFailure<int, String> rxList = RxListUndefinedFailure<int, String>(initial: <int>[1, 2, 3, 4, 5]);
        final ObservableListUndefinedFailure<int, String> rxNew = rxList.filterItem((final int item) => item.isOdd);
    ...
    group('rxItem', () {
      test('should return the item at the given index', () async {
        final RxListUndefinedFailure<int, String> rxList = RxListUndefinedFailure<int, String>(initial: <int>[1, 2, 3, 4, 5]);
        final Observable<StateOf<int?, UndefinedFailure<String>>> rxItem = rxList.rxItem(2);
    ...
    group('mapItem', () {
      test('Should map data change', () async {
        final RxListUndefinedFailure<int, String> rxList = RxListUndefinedFailure<int, String>(initial: <int>[1, 2, 3, 4, 5]);
        final ObservableListUndefinedFailure<String, String> rxNew = rxList.mapItem((final int item) => item.toString());

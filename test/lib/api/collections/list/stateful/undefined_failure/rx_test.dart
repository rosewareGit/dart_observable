  ...
  group('RxListEmptyResult', () {
    group('operator []=', () {
      ...
      test('Should set the item when the state is undefined', () {
        final RxListUndefinedFailure<int, dynamic> rxList = RxListUndefinedFailure<int, dynamic>();
        expect(rxList.value.custom!.isUndefined, true);
      ...
      test('Should set the item when the state is failure', () {
        ...
        rxList.setState(UndefinedFailure<dynamic>.failure('failure'));
        expect(rxList.value.custom!.isFailure, true);
        expect(rxList.value.custom!.failure, 'failure');
    ...
    group('add', () {
      ...
      test('Should add the item when the state is undefined', () {
        final RxListUndefinedFailure<int, dynamic> rxList = RxListUndefinedFailure<int, dynamic>();
        expect(rxList.value.custom is UndefinedFailure, true);
    ...
    group('applyAction', () {
      test('Should apply the action - data', () {
        final RxListUndefinedFailure<int, String> rxList = RxListUndefinedFailure<int, String>(
          initial: <int>[1, 2, 3],
        );
      ...
      test('Should apply the action - failure', () {
        ...
        final StateOf<ObservableListChange<int>, UndefinedFailure<String>>? changeData =
            rxList.setState(UndefinedFailure<String>.failure('failure'));
        expect(rxList.value.custom!.isFailure, true);
        expect(changeData!.custom!.failure, 'failure');
      });
      ...
      test('Should apply the action - empty', () {
        ...
        rxList.setState(UndefinedFailure<String>.undefined());
        expect(rxList.value.custom!.isUndefined, true);
      });
    });
    //
